...
def load_coordinates_dataset():
    """Load the broad TNT screen coordinates dataset"""
    dataset_path = "/mnt/upramdya_data/MD/Broad_TNT/Datasets/251118_13_summary_broad_TNT_screen_Data/coordinates/pooled_coordinates.feather"
...
def generate_all_trajectory_plots(
    ...
    if output_dir is None:
        output_dir = Path("/mnt/upramdya_data/MD/Broad_TNT/Plots/trajectories")
    else:
...
Examples:
  ...
  python plot_broad_tnt_trajectories.py --output-dir /path/to/output
    ...
    parser.add_argument(
        "--output-dir",
        type=str,
        default="/mnt/upramdya_data/MD/Broad_TNT/Plots/trajectories",
        help="Directory to save plots (default: /mnt/upramdya_data/MD/Broad_TNT/Plots/trajectories)",
    )
