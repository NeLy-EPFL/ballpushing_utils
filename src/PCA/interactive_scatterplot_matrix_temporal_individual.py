#!/usr/bin/env python3
"""
Interactive Scatterplot Matrix for Individual Flies - Temporal PCA (fPCA) Results using HoloViews
This script creates an interactive pairwise scatterplot matrix showing all combinations of temporal PCA components
for individual flies with brain region color coding, significance highlighting, and hover tooltips with metadata.
"""
...
# Plot configuration templates - reduced point sizes for individual flies
hv_main = {
    "scatter": {
        "size": 4,  # Smaller size for individual flies
        "alpha": 0.4,  # Further reduced alpha for better visibility when many points
        "line_color": "black",
        "line_width": 0.3,
    },
    "plot": {
...
def create_interactive_scatterplot_matrix_individual(
    ...
    # Prepare plotting data for individual flies
    fly_data, all_significant, static_significant, temporal_significant = prepare_individual_plotting_data(
    ...
    # Print summary
    print(f"\n=== Individual Fly Temporal PCA Scatterplot Matrix Summary ===")
