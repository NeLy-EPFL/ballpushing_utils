...
def create_loadings_heatmap():
    ...
    # Customize the plot
    ax.set_title(f'{method_name} Loadings Heatmap - Simplified Static Analysis\n(Metrics with NaNs Removed)', 
    ...
    plt.figtext(0.02, 0.02, f'Analysis includes {metrics_count} metrics (no missing values)\n'
