...
def load_and_clean_dataset(test_mode=False, test_sample_size=200):
    ...
    dataset_path = "/mnt/upramdya_data/MD/Ballpushing_TNTScreen/Datasets/250805_16_summary_ball_types_Data/summary/pooled_summary.feather"
...
def main(overwrite=True, test_mode=False):
    ...
    base_output_dir = Path("/mnt/upramdya_data/MD/Ballpushing_TNTScreen/Plots/Summary_metrics/BallTypes_Mannwhitney")
