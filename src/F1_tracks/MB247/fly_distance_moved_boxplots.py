#!/usr/bin/env python3
"""
Script to create boxplots with superimposed scatter plots for fly_distance_moved metric for TNT MB247 dataset.
...
def main():
    ...
    create_boxplot_with_scatter_combined(
        ...
        title="Fly Distance Moved (Activity) by Genotype + Pretraining (TNT MB247)",
        ax=ax,
