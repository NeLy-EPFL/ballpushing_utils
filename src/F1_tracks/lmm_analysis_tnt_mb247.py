#!/usr/bin/env python3
"""
Linear Mixed-Effects Model (LMM) Analysis for TNT MB247 experiments.
...
Usage:
    python lmm_analysis_tnt_mb247.py [--metric distance_moved] [--max-iter 200]
"""
...
def main(metric="distance_moved", max_iter=200):
    ...
    """
    print("\n" + "=" * 120)
    print(f"LINEAR MIXED-EFFECTS MODEL ANALYSIS: {metric}")
    print("=" * 120)
    ...
    # Initialize LMM analysis
    output_dir = Path("/mnt/upramdya_data/MD/F1_Tracks/Plots/lmm_analysis")
    ...
    if has_singular:
        ...
        print("  3. For power analysis, use the existing power_analysis_tnt_mb247.py script")
        print("\nTo run OLS instead:")
    ...
    print("  • Genotype[T.TNTxMB247]: Effect of TNTxMB247 vs control (TNTxEmptyGal4)")
    print("  • Pretraining[T.y]: Effect of pretraining (y vs n)")
    print("  • Genotype[T.TNTxMB247]:Pretraining[T.y]: Interaction (does pretraining effect differ by genotype?)")
    print("\nInterpretation:")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Linear Mixed-Effects Model analysis for TNT MB247 experiments")
    parser.add_argument(
