...
def main():
    ...
    # Formatting
    plt.xlabel(f"Max Distance - Training Ball", fontsize=12)
    plt.ylabel(f"Max Distance - Test Ball", fontsize=12)
    plt.title("Training vs Test Ball Max Distance\n(Pretrained Flies Only)", fontsize=14, fontweight="bold")
    ...
    # Save the plot
    output_path = Path(__file__).parent / "training_vs_test_max_distance_scatter.png"
