#!/usr/bin/env python3
"""
Script to create boxplots with superimposed scatter plots for significant_ratio metric for TNT LC10-2 dataset.
...
def main():
    ...
    create_boxplot_with_scatter_combined(
        ...
        title="Significant Ratio by Genotype + Pretraining (TNT LC10-2)",
        ax=ax,
